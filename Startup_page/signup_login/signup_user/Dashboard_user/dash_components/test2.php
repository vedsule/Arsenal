...
<main class = "allicons" >
		...
		while($data = $result->fetch_assoc()){
			...
			<div>
				<div class='activity-container'   style = ' background = red ;' >
					<span>$name_without_extension<br></span>
					<img class='menu-button' src='$source' alt='menu' style=' width:25px;'>
					<span>  </span>
					<span style = 'font-size : 15px'>$_fileActualExtension : $sizeround Mb<br></span>
				</div>
			
				<button style='background-color: #33387a; border-radius:3px'> <a href = 'open.php?file_id=$_fileid&extension=$_fileActualExtension' style = ' text-align: center; position: relative; text-decoration : none; color : white; margin-right:6px;'> open </a></button> 
				<button style='background-color: #33387a; border-radius:3px'> <a href = 'download.php?file_id=$_fileid&extension=$_fileActualExtension' style = ' text-align: center; position: relative;text-decoration : none; color : white;  margin-right:6px;'> download </a></button> 
				<button style='background-color: #33387a; border-radius:3px'> <a href = 'delete.php?file_id=$_fileid&extension=$_fileActualExtension' style = 'text-align: center; position: relative; text-decoration : none; color : white; margin-right:6px;'> delete </a></button> 
				
				<button style='background-color: #33387a; border-radius:3px'> 
				...
				style = ' text-align: center; position: relative;text-decoration : none; color : white; margin-right:6px;'> 
				rename </a></button> 
