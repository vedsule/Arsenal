  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($_POST['username'])){
      ...
      if($conf_password == $password){
        ...
        $sql1 = "SELECT * FROM admin_reg WHERE username = '$username' ";
        ...
        if($result && $result1){
            ...
            if($num > 0 || $num1 > 0){
              ...
              $sql = "INSERT INTO user_reg "."(name,username,password) "."VALUES"."('$name','$username','$password')";
              $result = mysqli_query($con,$sql);
    ...
    if(isset($_POST['username_used'])){
      ...
      if($result){
        ...
        if($num > 0){
          ...
          header('location:Dashboard_user/dashboard-user.php');
        }
        else {
...
<head>
  <title>user-login</title>
    ...
    <script src="signup_user.js"></script>
    
</head>
<body>
<div class="cont_principal">
<h1 style = "text-align: center; position: relative; margin-top : 70px; font-family: Quicksand, sans-serif;  color: #4c6cf8; ">
user login</h1>
<div class="complex11"  style = " position:relative; margin-top:205px;">
  ...
  <!-- onsubmit="setAction()"   -->
  <form action = "signup_user.php" method = "post" id="form126">
